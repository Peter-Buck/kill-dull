...
(function () {
  ...
  function buildHomepageIntroductions() {
    ...
    drift.id = 'drift';
    drift.innerHTML = '<div class="product-orientation"><span></span><span>DRIFT</span></div>' +
      '<span class="hero-line-wrap"><h2 class="hero-line js-fit">GOOD DECISIONS CAN</h2></span><span class="hero-line-wrap"><h2 class="hero-line js-fit">STILL ADD UP WRONG.</h2></span>' +
    ...
    style.textContent =
      ...
      '.pitch-intro{background:var(--paper);color:var(--ink)}.pitch-intro .product-orientation{color:#77736b}.pitch-intro .product-orientation:before{background:#aaa69d}.pitch-intro .hero-line{color:var(--ink)}' +
      ...
      '.drift-intro{background:var(--ink);color:var(--paper)}.drift-intro .hero-line{color:var(--paper)}.drift-copy{width:100%;max-width:50%;font-size:17px;line-height:1.8;color:var(--text-body);margin-top:36px}.drift-copy p{margin:0}.drift-copy p+p{margin-top:24px}.drift-close{margin-top:48px;display:flex;flex-direction:column;font-family:"Space Grotesk",sans-serif;font-size:clamp(24px,3vw,48px);line-height:1.05;letter-spacing:-.02em;color:var(--paper)}.drift-close strong:last-child{color:var(--yellow)}' +
      '@media(max-width:767px){.product-orientation{margin-bottom:30px}.pitch-copy,.drift-copy{max-width:100%}.pitch-steps{grid-template-columns:1fr}.pitch-steps>div,.pitch-steps>div+div{padding:18px 0;border-right:0;border-bottom:1px solid #aaa69d}.pitch-steps>div:last-child{border-bottom:0}.pitch-go{margin-left:0}}' +
