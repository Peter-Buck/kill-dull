...
(function () {
  ...
  function buildHomepage() {
    ...
    close.innerHTML =
      ...
      '<p class="close-lead"><strong>Worry or excitement?</strong></p>' +
      '<div class="close-options"><div><span>BENCH handles the consequential decisions.</span><a href="/bench#discuss">Bench it <b>→</b></a></div><div><span>PITCH handles the things you can’t wait to make.</span><a href="https://pitchagainstdull.com">Pitch it <b>→</b></a></div></div>';
    ...
    style.textContent =
      ...
      '.close-lead{margin:36px 0 0;font-size:17px;line-height:1.8}.close-options{display:grid;grid-template-columns:1fr 1fr;gap:1px;margin-top:24px}.close-options>div{display:flex;flex-direction:column;gap:12px;padding:28px 28px 30px 0}.close-options>div+div{padding-left:28px}.close-options span{font-size:17px}.close-options a{font-size:28px;font-weight:700;text-decoration:none;text-transform:none}.close-options b{display:inline-block;font-weight:700;transition:transform .22s cubic-bezier(.2,.8,.2,1)}.close-options a:hover b{transform:translateY(-5px)}' +
      ...
      '@media(prefers-reduced-motion:reduce){#masthead,#registrar{transition:none}.pitch-watch .pulse-square{animation:none}.pitch-arrow,.text-link span,.close-options b{transition:none}}';
