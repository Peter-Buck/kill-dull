...
(function(){
  ...
  function normalizeShell(){
    ...
    if(desktop) desktop.innerHTML='<a class="reg-item'+(key==='home'?' is-current':'')+'" href="/">KILL DULL</a><a class="reg-item'+(key==='discipline'?' is-current':'')+'" href="/discipline">THE DISCIPLINE</a><a class="reg-item'+(key==='bench'?' is-current':'')+'" href="/bench">THE BENCH</a><a class="reg-item'+(key==='readings'?' is-current':'')+'" href="/readings">READINGS</a>';
