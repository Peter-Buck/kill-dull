...
(function(){
  ...
  style.textContent='@keyframes kd-terminal-compound{0%{transform:scale(1)}50%{transform:scale(1.175)}100%{transform:scale(1)}}'+
   ...
   so it disappeared for exactly the widths an iPad holds. *//* One measure for every band on every page: the hairline sits the same
   ...
   cards ends on that instead, and keeps its own edge. */':root{--kd-band-top:82px;--kd-band-bottom:112px}'+
    ...
    '@media(min-width:768px) and (max-width:1000px){.unified-nav-products{display:flex!important;align-items:center!important}}'+
