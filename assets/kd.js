  ...
  function buildHomepage() {
    ...
    close.innerHTML =
      ...
      '<div class="close-options">' +
        '<a class="close-choice" href="/bench#discuss"><span class="close-choice-label">ABOUT TO DECIDE?</span><strong class="close-choice-action">Bench it <b>→</b></strong><span class="close-reveal"><span>A consequential marketing decision.<br>A lot riding on the answer.<br><strong>Now is the time to question it.</strong></span><strong class="close-reveal-action">Bench it <b>→</b></strong></span></a>' +
        '<a class="close-choice" href="https://pitchagainstdull.com"><span class="close-choice-label">ABOUT TO MAKE?</span><strong class="close-choice-action">Pitch it <b>→</b></strong><span class="close-reveal"><span>A creative idea in the making.<br>A lot riding on what it becomes.<br><strong>Now is the time to make it better.</strong></span><strong class="close-reveal-action">Pitch it <b>→</b></strong></span></a>' +
      '</div>';
    ...
    style.textContent =
      ...
      '#home-close{background:var(--yellow)!important;color:var(--ink)!important;padding-bottom:96px}.home-new-close .hero-line{color:var(--ink)!important}.close-options{display:grid;grid-template-columns:1fr 1fr;gap:28px;margin-top:54px}.v5-home #home-close .close-choice{position:relative;overflow:hidden;aspect-ratio:1/1;min-height:0;width:100%!important;max-width:none!important;padding:34px!important;border:0!important;background:var(--paper)!important;color:var(--ink)!important;display:flex!important;flex-direction:column;align-items:flex-start!important;justify-content:space-between;gap:0!important;text-decoration:none!important;text-transform:none;box-sizing:border-box}.v5-home #home-close .close-choice:hover{border-color:transparent!important;background:var(--paper)!important;color:var(--ink)!important}.close-choice-label{font-family:"IBM Plex Mono",monospace;font-size:15px;letter-spacing:.14em}.close-choice-action,.close-reveal-action{display:inline-flex!important;align-items:center;gap:14px;width:max-content;border:.5px solid currentColor;padding:12px 16px;box-sizing:border-box}.close-choice-action{font-size:clamp(36px,4vw,58px);line-height:1;letter-spacing:-.035em}.close-choice-action b,.close-reveal-action b{display:inline-flex!important;align-items:center;font-size:0!important;transform:none!important;transition:transform .22s cubic-bezier(.2,.8,.2,1)}.close-choice-action b:before,.close-reveal-action b:before{content:"↗";font-size:.68em;line-height:1}.close-choice:hover .close-choice-action b,.close-choice:hover .close-reveal-action b{transform:translate(2px,-2px)!important}.close-reveal{position:absolute;left:0;right:0;bottom:0;height:68%;padding:34px;background:var(--ink);color:var(--paper)!important;display:flex;flex-direction:column;justify-content:space-between;font-size:clamp(18px,1.7vw,24px);line-height:1.55;transform:translateY(100%);transition:transform .34s cubic-bezier(.2,.8,.2,1);box-sizing:border-box}.close-reveal *{color:var(--paper)!important}.close-reveal>span{font-size:inherit!important}.close-reveal-action{font-size:clamp(28px,3vw,44px);line-height:1;letter-spacing:-.03em}.close-choice:hover .close-reveal,.close-choice:focus-visible .close-reveal{transform:translateY(0)}' +
