...
(function(){
  ...
  style.textContent='@keyframes kd-terminal-compound{0%{transform:scale(1)}50%{transform:scale(1.175)}100%{transform:scale(1)}}'+
    ...
    '.masthead-top{display:flex!important;flex-direction:column!important;align-items:center!important;gap:16px!important;padding:40px 120px 24px!important;background:var(--ink)!important;color:#fff!important}'+
    ...
    '.masthead-date:empty{display:none!important}.masthead .masthead-rule{margin-bottom:12px!important}.masthead .masthead-designation{margin-top:-11px!important;word-spacing:-.25em!important}.masthead-designation{text-align:center!important;padding:0 120px 24px!important;background:var(--ink)!important}'+
    ...
    '@media(max-width:767px){.masthead-top{padding:34px 24px 24px!important}.masthead-wordmark{font-size:34px!important}.masthead-date{font-size:9px!important;letter-spacing:.08em!important}.masthead-designation{font-size:min(13px,calc((100vw - 50px) / 31.6))!important;letter-spacing:.02em!important}.masthead-designation{padding:0 12px 19px!important}.masthead .masthead-designation{margin-top:-11px!important}.reg-mobile-current:has(#reg-mobile-label.is-long){padding-left:12px!important;padding-right:12px!important}#reg-mobile-label.is-long{white-space:nowrap!important;font-size:min(13px,calc((100vw - 222px) / 13.8))!important;letter-spacing:0!important;margin-right:8px!important}.masthead-rule{margin:0 24px!important}.unified-nav{grid-template-columns:1fr auto!important}.registrar-mobile{grid-column:1!important}.unified-nav-products{display:flex!important;grid-column:2!important;justify-self:end!important;padding-right:24px!important}.footer-inner{padding:48px 24px!important}.footer-section{grid-template-columns:1fr!important;gap:12px!important}}'+
