...
(function(){
  ...
  style.textContent='@keyframes kd-terminal-compound{0%{transform:scale(1)}50%{transform:scale(1.175)}100%{transform:scale(1)}}'+
    ...
    '.masthead-designation{font-family:"IBM Plex Mono",monospace!important;font-size:15px!important;font-weight:500!important;letter-spacing:.04em!important;line-height:1!important;color:#fff!important;opacity:1!important;text-transform:uppercase!important;white-space:nowrap!important}'+
    '.masthead-date{text-align:center!important;align-self:center!important}'+
    '.masthead-date:empty{display:none!important}.masthead .masthead-rule{margin-bottom:0!important}.masthead .masthead-designation{margin-top:-11px!important;word-spacing:-.25em!important}.masthead-designation{text-align:center!important;padding:0 120px 32px!important;background:var(--ink)!important}'+
    ...
    /* A tablet had no CONTACT. The chapters row is shown from 768px up, but the
   call to action was hidden below 1000px and only brought back below 768px,
   so it disappeared for exactly the widths an iPad holds. */'@media(min-width:768px) and (max-width:1000px){.unified-nav-products{display:flex!important;align-items:center!important}}'+
    ...
    '@media(max-width:767px){.masthead-top{padding:26.5px 24px 24px!important}.masthead-wordmark{font-size:34px!important}.masthead-date{font-size:9px!important;letter-spacing:.08em!important}.masthead-designation{font-size:min(13px,calc((100vw - 50px) / 31.6))!important;letter-spacing:.02em!important}.masthead-designation{padding:0 12px 26.5px!important}.masthead .masthead-designation{margin-top:-11px!important}.reg-mobile-current:has(#reg-mobile-label.is-long){padding-left:12px!important;padding-right:12px!important}#reg-mobile-label.is-long{white-space:nowrap!important;font-size:min(13px,calc((100vw - 222px) / 13.8))!important;letter-spacing:0!important;margin-right:8px!important}.masthead-rule{margin:0 24px!important}.unified-nav{grid-template-columns:1fr auto!important}.registrar-mobile{grid-column:1!important}.unified-nav-products{display:flex!important;grid-column:2!important;justify-self:end!important;padding-right:24px!important}.footer-inner{padding:48px 24px!important}.footer-section{grid-template-columns:1fr!important;gap:12px!important}}'+
  ...
  function normalizeShell(){
    ...
    if(footer) footer.innerHTML='<div class="footer-inner"><div class="footer-bureau">DENSE IDEA COMPANY™.</div><div class="footer-index"><div class="footer-section"><div class="footer-section-label">DISCIPLINE</div><nav aria-label="Discipline"><a href="/discipline">Dense Ideas</a></nav></div><div class="footer-section"><div class="footer-section-label">BENCH</div><nav aria-label="Bench"><a href="/bench">How the Bench works</a><a href="/readings">Private Readings</a><a href="/readings#record">Published Readings</a></nav></div><div class="footer-section"><div class="footer-section-label">KILL DULL</div><nav aria-label="Kill Dull"><a href="/bureau">Department of Hard Evidence</a><a href="/accessibility" aria-label="Accessibility statement">Accessibility</a><a href="/privacy" aria-label="Privacy policy">Privacy</a><a href="/terms" aria-label="Terms of use">Terms</a><a href="/contact">Contact</a></nav></div></div><div class="footer-colophon"><span>© 2026 Kill Dull. All rights reserved.</span><button type="button" class="kd-consent-settings">Cookie settings</button></div></div>';
  }
